...
.method public bridge synthetic a(Ljava/lang/Object;Lorg/json/JSONObject;)V
    ...
    invoke-virtual {p0, p1, p2}, Lx8/b;->d(Ljava/util/Map;Lorg/json/JSONObject;)V
...
.method public bridge synthetic b(Lorg/json/JSONObject;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lx8/b;->c(Lorg/json/JSONObject;Ljava/util/Map;)V
...
.method public c(Lorg/json/JSONObject;Ljava/util/Map;)V
    ...
    invoke-static {v1}, Lhl/t;->t(Ljava/lang/CharSequence;)Z
    ...
    invoke-static {v1, v0}, Lci/l;->u([Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public d(Ljava/util/Map;Lorg/json/JSONObject;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string p1, "COL_SETTING_AUTO_SCROLL"
    ...
    const-string p1, "COL_SETTING_REFRESH_ENTERING"

    .line 19
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_CHECK_CURRENT_CITY_LOCATION"

    .line 20
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_NOTIFICATION"

    .line 21
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_REFRESH_ROAMING"

    .line 22
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_S_PLANNER"

    .line 23
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_LAST_UPDATED_VERSION_OF_NAME_LIST"

    .line 24
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_LAST_UPDATED_TIME_OF_NAME_LIST"
    ...
    const-string p1, "COL_SETTING_CURRENT_LOCATION_ERROR"

    .line 26
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_EDGE_SCREEN"

    .line 27
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_LOCKSCREEN_AND_S_VIEW_COVER"

    .line 28
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_WIDGET_BACKGROUND"

    .line 29
    invoke-virtual {v0, p1, v1}, Lorg/json/JSONObject;->put(Ljava/lang/String;I)Lorg/json/JSONObject;

    const-string p1, "COL_SETTING_THEME_VERSION"

    .line 30
    invoke-virtual {v0, p1, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string p1, "CP_INFO"
    ...
    const-string p1, "BACKUP_FILE_TIMESTAMP"
    ...
    const-string v1, "weather bnr, Backup setting: "
    ...
    invoke-virtual {p1, v2, p2}, Llb/c;->b(Ljava/lang/String;Ljava/lang/String;)V
