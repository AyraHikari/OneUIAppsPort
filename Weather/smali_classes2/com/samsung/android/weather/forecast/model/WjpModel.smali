.class public final Lcom/samsung/android/weather/forecast/model/WjpModel;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;)V",
        "name",
        "",
        "getName",
        "()Ljava/lang/String;",
...
# instance fields
.field private final synthetic $$delegate_0:Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;

.field private name:Ljava/lang/String;


# direct methods
.method public constructor <init>(Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;)V
    .locals 1
    ...
    .line 13
    iput-object p1, p0, Lcom/samsung/android/weather/forecast/model/WjpModel;->$$delegate_0:Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;

    const-string p1, "JPN_V4"

    .line 14
    iput-object p1, p0, Lcom/samsung/android/weather/forecast/model/WjpModel;->name:Ljava/lang/String;
...
.method public getCategoryUri(Ljava/lang/String;ILjava/lang/String;)Landroid/net/Uri;
    ...
    iget-object v0, p0, Lcom/samsung/android/weather/forecast/model/WjpModel;->$$delegate_0:Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;

    invoke-virtual {v0, p1, p2, p3}, Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;->getCategoryUri(Ljava/lang/String;ILjava/lang/String;)Landroid/net/Uri;
...
.method public getHomeUri(Ljava/lang/String;ILjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;->getHomeUri(Ljava/lang/String;ILjava/lang/String;)Landroid/net/Uri;
...
.method public getName()Ljava/lang/String;
    ...
    .line 14
    iget-object v0, p0, Lcom/samsung/android/weather/forecast/model/WjpModel;->name:Ljava/lang/String;
...
.method public getPrivacyUri(Ljava/util/Locale;)Landroid/net/Uri;
    ...
    invoke-virtual {v0, p1}, Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;->getPrivacyUri(Ljava/util/Locale;)Landroid/net/Uri;
...
.method public getReportUri(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;->getReportUri(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public getTnCUri()Landroid/net/Uri;
    ...
    invoke-virtual {v0}, Lcom/samsung/android/weather/forecast/weblink/impl/WjpWebLink;->getTnCUri()Landroid/net/Uri;
