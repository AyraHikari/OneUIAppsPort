...
.method public final a(Landroidx/fragment/app/f;[Ljava/lang/String;Lfi/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lk9/q;->b(Landroid/app/Activity;[Ljava/lang/String;Lfi/d;)Ljava/lang/Object;
...
.method public final b(Landroid/app/Activity;[Ljava/lang/String;Lfi/d;)Ljava/lang/Object;
    ...
    new-instance v2, Lk9/q$b;

    invoke-direct {v2, v0}, Lk9/q$b;-><init>(Ljl/n;)V

    new-instance v3, Lk9/q$c;

    invoke-direct {v3, v0}, Lk9/q$c;-><init>(Ljl/n;)V

    invoke-virtual {v1, p1, p2, v2, v3}, Ll9/a;->b(Landroid/app/Activity;[Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/AlertDialog;

    move-result-object p1

    .line 4
    new-instance p2, Lk9/q$a;

    invoke-direct {p2, p1}, Lk9/q$a;-><init>(Landroid/app/AlertDialog;)V
