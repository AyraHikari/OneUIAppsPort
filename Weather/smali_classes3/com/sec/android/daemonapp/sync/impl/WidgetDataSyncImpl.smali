.class public final Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$Companion;,
        Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$WhenMappings;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;",
...
# static fields
.field public static final Companion:Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->Companion:Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$Companion;
...
.method public constructor <init>(Landroid/app/Application;Lcom/sec/android/daemonapp/sync/utils/PreventDuplicateBroadcast;)V
    ...
    .line 14
    iput-object p1, p0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->application:Landroid/app/Application;

    .line 15
    iput-object p2, p0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->preventDuplicateBroadcast:Lcom/sec/android/daemonapp/sync/utils/PreventDuplicateBroadcast;
...
.method public final getApplication()Landroid/app/Application;
    ...
    .line 14
    iget-object v0, p0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->application:Landroid/app/Application;
...
.method public final getPreventDuplicateBroadcast()Lcom/sec/android/daemonapp/sync/utils/PreventDuplicateBroadcast;
    ...
    .line 15
    iget-object v0, p0, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->preventDuplicateBroadcast:Lcom/sec/android/daemonapp/sync/utils/PreventDuplicateBroadcast;
...
.method public notifyError(Lcom/samsung/android/weather/sync/data/DataSyncErrorReason;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    const-string v0, "WidgetDataSyncImpl"

    invoke-static {v0, p2}, Lcom/samsung/android/weather/infrastructure/debug/SLog;->e(Ljava/lang/String;Ljava/lang/String;)V

    .line 37
    invoke-virtual {p0}, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->getApplication()Landroid/app/Application;
...
.method public sync(Lcom/samsung/android/weather/sync/data/DataSyncReason;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 19
    sget-object p2, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 27
    :pswitch_0
    sget-object p2, Lcom/samsung/android/weather/sync/data/DataSyncReason;->WIDGET_UPDATED:Lcom/samsung/android/weather/sync/data/DataSyncReason;

    if-eq p2, p1, :cond_0

    invoke-virtual {p0}, Lcom/sec/android/daemonapp/sync/impl/WidgetDataSyncImpl;->getPreventDuplicateBroadcast()Lcom/sec/android/daemonapp/sync/utils/PreventDuplicateBroadcast;
    ...
    invoke-virtual {p3}, Lcom/sec/android/daemonapp/util/WidgetIntentHelper$Companion;->getUpdateWidget()Landroid/content/Intent;
