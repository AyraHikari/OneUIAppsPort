.class public final Lcom/sec/android/daemonapp/appwidget/model/forecast/ForecastModel3X2;
.super Lcom/sec/android/daemonapp/appwidget/model/common/AbsWidgetModel;
.source "ForecastModel3X2.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/sec/android/daemonapp/appwidget/model/forecast/ForecastModel3X2;",
...
.method public constructor <init>(Lcom/sec/android/daemonapp/view/WidgetViewDecorator;Lcom/sec/android/daemonapp/entities/WidgetConfig;)V
    ...
    sget v0, Lcom/sec/android/daemonapp/widget/R$layout;->widget_main_forecast_3x2_ntt:I

    goto :goto_0

    .line 18
    :cond_0
    sget v0, Lcom/sec/android/daemonapp/widget/R$layout;->widget_main_forecast_3x2:I

    .line 19
    :goto_0
    sget v1, Lcom/sec/android/daemonapp/widget/R$layout;->widget_main_forecast_3x2_land:I
    ...
    .line 14
    iput-object p1, p0, Lcom/sec/android/daemonapp/appwidget/model/forecast/ForecastModel3X2;->viewDecorator:Lcom/sec/android/daemonapp/view/WidgetViewDecorator;
...
.method protected decorateMore(Landroid/content/Context;Landroid/widget/RemoteViews;Lcom/samsung/android/weather/data/model/Weather;Lcom/sec/android/daemonapp/common/WidgetTTS$TTSData;)V
    ...
    .line 26
    new-instance v0, Lcom/sec/android/daemonapp/view/ForecastViewDecorator;

    iget-object v1, p0, Lcom/sec/android/daemonapp/appwidget/model/forecast/ForecastModel3X2;->viewDecorator:Lcom/sec/android/daemonapp/view/WidgetViewDecorator;

    invoke-direct {v0, v1}, Lcom/sec/android/daemonapp/view/ForecastViewDecorator;-><init>(Lcom/sec/android/daemonapp/view/WidgetViewDecorator;)V

    .line 27
    invoke-virtual {p0}, Lcom/sec/android/daemonapp/appwidget/model/forecast/ForecastModel3X2;->getConfig()Lcom/sec/android/daemonapp/entities/WidgetConfig;

    move-result-object v1

    invoke-virtual {v0, p1, p2, v1, p3}, Lcom/sec/android/daemonapp/view/ForecastViewDecorator;->decoDate(Landroid/content/Context;Landroid/widget/RemoteViews;Lcom/sec/android/daemonapp/entities/WidgetConfig;Lcom/samsung/android/weather/data/model/Weather;)V
