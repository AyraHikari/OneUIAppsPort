.class Lcom/sec/android/app/myfiles/external/database/dao/FavoritesFileInfoDao_FileInfoDatabase_Impl$3;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/sec/android/app/myfiles/external/database/dao/FavoritesFileInfoDao_FileInfoDatabase_Impl$3;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/sec/android/app/myfiles/external/model/FavoritesFileInfo;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "UPDATE OR ABORT `favorites` SET `file_id` = ?,`_data` = ?,`parent_file_id` = ?,`webLink` = ?,`_id` = ?,`path` = ?,`name` = ?,`ext` = ?,`mime_type` = ?,`size` = ?,`date_modified` = ?,`parent_hash` = ?,`file_type` = ?,`is_hidden` = ?,`item_count` = ?,`item_count_with_hidden` = ?,`domain_type` = ?,`is_trashed` = ? WHERE `_id` = ?"
