...
# static fields
.field private static final TAG:Ljava/lang/String; = "AuthenticatorManager"
...
.method private checkAddLocalAuthenticatorInfoLocked(Landroid/util/SparseArray;Ljava/util/List;Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorOperation;S)V
    ...
    const-string/jumbo v1, "tlvAuthenticatorInfo is null"
    ...
    const-string/jumbo v2, "tlvAuthenticatorMetadata is null"
...
.method private registerAllLocalAuthenticatorInfosLocked(Ljava/util/List;)V
    ...
    const-string/jumbo v4, "status code is invalid : "
    ...
    const-string/jumbo v3, "tlvAuthenticatorInfos is null"
...
.method public getTlvGetInfoResponse()[B
    ...
    const-string/jumbo v4, "tlvAuthenticatorInfos is empty"
...
.method public declared-synchronized start(Landroid/content/Context;)V
    ...
    .line 86
    sget-boolean v1, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorManager;->mIsStarted:Z

    if-eqz v1, :cond_0

    const-string p1, "AuthenticatorManager already started"
...
.method public declared-synchronized unregisterHelperCommand(J)V
    ...
    const-string/jumbo p2, "unregisterHelperCommand failed"
