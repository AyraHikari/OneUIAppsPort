...
.field private static final TAG:Ljava/lang/String; = "SQLiteOpenHelperStorage"
...
.method public insert(Lcom/samsung/android/clavis/fido/uaf/ra/storage/StorageArgs;)Z
    ...
    .line 107
    iget-object v3, p0, Lcom/samsung/android/clavis/fido/uaf/ra/storage/SQLiteOpenHelperStorage;->mHelper:Lcom/samsung/android/clavis/fido/uaf/ra/storage/SQLiteOpenHelperStorage$Helper;

    invoke-virtual {v3}, Lcom/samsung/android/clavis/fido/uaf/ra/storage/SQLiteOpenHelperStorage$Helper;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    const-string v5, "args.getAuthenticatorIndex() is null"
    ...
    const-string v5, "args.getLocalCallerId() is null"
    ...
    const-string v5, "args.getRemoteCallerId() is null"
    ...
    const-string v5, "args.getAppId() is null"
    ...
    const-string v5, "args.getKeyHandle() is null"
    ...
    const-string v5, "args.getKeyId() is null"
    ...
    const-string v6, "AUTHENTICATOR_INDEX"
    ...
    const-string v6, "LOCAL_CALLER_ID"
    ...
    const-string v6, "REMOTE_CALLER_ID"
    ...
    invoke-direct {p1, v6, v5}, Ljava/text/SimpleDateFormat;-><init>(Ljava/lang/String;Ljava/util/Locale;)V
    ...
    invoke-virtual {p1, v5}, Ljava/text/SimpleDateFormat;->setTimeZone(Ljava/util/TimeZone;)V
    ...
    const-string v5, "FURA_RI_TABLE"

    .line 129
    invoke-virtual {v3, v5, p1, v4}, Landroid/database/sqlite/SQLiteDatabase;->insert(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    .line 131
    invoke-static {v2, v4}, Lcom/samsung/android/clavis/fido/uaf/ra/common/util/RaLog;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public search(Lcom/samsung/android/clavis/fido/uaf/ra/storage/StorageArgs;Lcom/samsung/android/clavis/fido/uaf/ra/storage/StorageSearchOption;)Ljava/util/List;
    ...
    const-string/jumbo v1, "search result = "
    ...
    const-string/jumbo v1, "search counts = "
