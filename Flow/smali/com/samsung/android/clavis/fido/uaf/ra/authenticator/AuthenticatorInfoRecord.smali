...
.method static constructor <clinit>()V
    ...
    .line 39
    const-class v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->TAG:Ljava/lang/String;
...
.method private constructor <init>(Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord$Builder;)V
    ...
    :goto_0
    const-string v4, "getTlvAuthenticatorIndex is null"
    ...
    iput-object v1, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->authenticatorIndex:Ljava/lang/Short;
    ...
    :goto_1
    const-string v4, "getTlvAaid is null"
    ...
    iget-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->tlvAuthenticatorInfo:Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorInfo;

    invoke-virtual {v4}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorInfo;->getTlvAaid()Lcom/sec/android/fido/uaf/message/internal/tag/uafv1tlv/TlvAaid;

    move-result-object v4

    invoke-virtual {v4}, Lcom/sec/android/fido/uaf/message/internal/tag/uafv1tlv/TlvAaid;->getAaid()[B

    move-result-object v4

    invoke-direct {v1, v4}, Ljava/lang/String;-><init>([B)V

    iput-object v1, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->aaid:Ljava/lang/String;
    ...
    :goto_2
    const-string v5, "tlvAuthenticatorMetadata is null"
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->isSecondFactor:Ljava/lang/Boolean;
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->isRoaming:Ljava/lang/Boolean;
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->hasInternalKeyHandlesStorage:Ljava/lang/Boolean;
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->hasBuiltInUIForEnrollVerify:Ljava/lang/Boolean;
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->hasBuiltInUIForSettings:Ljava/lang/Boolean;
    ...
    iput-object v5, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->needAppIdParam:Ljava/lang/Boolean;
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->isEnrollNotSupported:Ljava/lang/Boolean;

    .line 134
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getMaxKeyHandles()S
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->maxKeyHandles:Ljava/lang/Short;

    .line 136
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getUserVerification()I
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->userVerification:Ljava/lang/Integer;

    .line 138
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getKeyProtection()S
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->keyProtection:Ljava/lang/Short;

    .line 140
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getMatcherProtection()S
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->matcherProtection:Ljava/lang/Short;

    .line 142
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getTransactionConfirmationDisplay()S
    ...
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->transactionConfirmationDisplay:Ljava/lang/Short;

    .line 144
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvAuthenticatorMetadata;->getAuthenticationAlg()S
    ...
    iput-object v1, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->authenticationAlg:Ljava/lang/Short;
    ...
    invoke-virtual {v1}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayContentType;->getContentType()[B
    ...
    .line 152
    :cond_a
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->tcContentType:Ljava/lang/String;
    ...
    check-cast v5, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;
    ...
    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getWidth()J

    move-result-wide v8

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getHeight()J

    move-result-wide v10

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getBitDepth()S

    move-result v12

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getColourType()S

    move-result v13

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getCompression()S

    move-result v14

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getFilter()S

    move-result v16

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getInterlace()S

    move-result v17

    invoke-virtual {v5}, Lcom/sec/android/fido/uaf/message/internal/tag/tlv/TlvTcDisplayPngCharacteristics;->getPlte()[B
    ...
    .line 174
    :cond_b
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->tcDisplayPngCharacteristicsList:Ljava/util/List;
    ...
    .line 192
    :cond_e
    iput-object v4, v0, Lcom/samsung/android/clavis/fido/uaf/ra/authenticator/AuthenticatorInfoRecord;->supportedExtensionIDList:Ljava/util/List;
...
.method public validate()V
    ...
    :goto_2
    const-string v0, "tlvAuthenticatorInfo is null"
