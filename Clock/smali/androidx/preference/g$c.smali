...
.method private p(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    .locals 4
...
.method public l(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$o0;)V
    ...
    .line 9
    iget-object v6, p0, Landroidx/preference/g$c;->a:Landroid/graphics/drawable/Drawable;

    if-eqz v6, :cond_1

    invoke-direct {p0, v3, p2}, Landroidx/preference/g$c;->p(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    ...
    iget v7, p0, Landroidx/preference/g$c;->b:I
    ...
    .line 12
    :cond_1
    iget-object v5, p0, Landroidx/preference/g$c;->d:Landroidx/preference/g;

    invoke-static {v5}, Landroidx/preference/g;->V1(Landroidx/preference/g;)Z
    ...
    invoke-static {v5}, Landroidx/preference/g;->W1(Landroidx/preference/g;)Lb/a/p/d;
    ...
    invoke-virtual {v5, v4}, Lb/a/p/b;->g(I)V

    .line 16
    iget-object v4, p0, Landroidx/preference/g$c;->d:Landroidx/preference/g;

    invoke-static {v4}, Landroidx/preference/g;->W1(Landroidx/preference/g;)Lb/a/p/d;

    move-result-object v4

    invoke-virtual {v4, v3, p1}, Lb/a/p/d;->b(Landroid/view/View;Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Landroidx/preference/g;->X1(Landroidx/preference/g;)Lb/a/p/b;
    ...
    invoke-static {v4}, Landroidx/preference/g;->X1(Landroidx/preference/g;)Lb/a/p/b;

    move-result-object v4

    invoke-virtual {v4, v3, p1}, Lb/a/p/b;->b(Landroid/view/View;Landroid/graphics/Canvas;)V
    ...
    .line 19
    :cond_5
    iget-object p2, p0, Landroidx/preference/g$c;->d:Landroidx/preference/g;

    invoke-static {p2}, Landroidx/preference/g;->V1(Landroidx/preference/g;)Z
    ...
    invoke-static {p2}, Landroidx/preference/g;->Y1(Landroidx/preference/g;)Lb/a/p/b;

    move-result-object p2

    invoke-virtual {p2, p1}, Lb/a/p/b;->a(Landroid/graphics/Canvas;)V
...
.method public n(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p1, Landroidx/preference/g;->e0:Landroidx/recyclerview/widget/RecyclerView;
